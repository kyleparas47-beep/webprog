...
<body>
    <header class="header">
        <div class="header-container">
            ...
            <nav class="nav-links">
                <a href="/frontend/admin_page.php" class="nav-link active">HOME</a>
                <span class="nav-divider">|</span>
                <a href="/frontend/admin_calendar.php" class="nav-link">CALENDAR</a>
                <span class="nav-divider">|</span>
                <a href="#" class="nav-link">VIEW EVENTS</a>
            </nav>

            <div class="header-icons">
                <button onclick="window.location.href="/frontend/logout.html"" class="icon-btn user-icon">
            ...
            <div class="content-layout">
                <div class="content-left">
                    ...
                    <div class="action-section">
                        ...
                        <a href="/frontend/admin_calendar.php" class="add-events-link">
                            + add events >
                        </a>
                    </div>
                </div>
                <div class="content-right">
                    <div class="image-container">
                        <div class="image-card image-front">
                            <img src="/frontend/assets/492508047_1000140838968339_1613408679840476886_n.jpg" alt="National University students celebrating and cheering in blue uniforms" class="event-image">
                        </div>
                        <div class="image-card image-back">
                            <img src="/frontend/assets/images.jpg" alt="National University campus event with students gathered outdoors" class="event-image">
                        </div>
                    </div>
                </div>
            </div>
