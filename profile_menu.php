...
<div id="profileMenuOverlay" class="profile-menu-overlay" onclick="closeProfileMenu()"></div>
...
window.showProfileMenu = function() {
    console.log('showProfileMenu called'); // Debug log
    ...
    if (menu && overlay) {
        ...
        console.error('Menu found:', !!menu);
        console.error('Overlay found:', !!overlay);
    }
};

window.closeProfileMenu = function() {
    console.log('closeProfileMenu called'); // Debug log
    const menu = document.getElementById('profileMenu');
    const overlay = document.getElementById('profileMenuOverlay');
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('Profile menu elements check:');
    const menu = document.getElementById('profileMenu');
    const overlay = document.getElementById('profileMenuOverlay');
    
    console.log('profileMenu element:', menu);
    console.log('profileMenuOverlay element:', overlay);
    
    if (menu) {
        console.log('Menu initial classes:', menu.className);
        console.log('Menu initial transform:', window.getComputedStyle(menu).transform);
        console.log('Menu initial display:', window.getComputedStyle(menu).display);
        console.log('Menu initial visibility:', window.getComputedStyle(menu).visibility);
        console.log('Menu initial opacity:', window.getComputedStyle(menu).opacity);
    }
    
    // Temporary: Force menu to be visible for testing
    setTimeout(function() {
        if (menu) {
            console.log('Forcing menu to be visible for testing...');
