...
$show_success = isset($_GET['registered']) && $_GET['registered'] === 'success';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        ...
        /* Responsive Styles for Student Calendar */
...
<body>
    ...
    <div id="successNotification" class="success-notification">
        <div class="success-content">
            ...
            <div>
                <strong>Successfully Pre-Registered!</strong>
                <p>You have been pre-registered for this event. Your ticket is ready!</p>
            </div>
        </div>
    </div>
    <style>
                ...
                <div class="ticket-header-popup">
                    ...
                    <div class="university-logo">
                        <div class="logo-circle">
                            <img src="../../assets/images/national-university-philippines-logo-png_seeklogo-499282-removebg-preview.png" 
                                 alt="NU Logo" 
    ...
    <script src="../../assets/js/calendar_functions.js"></script>
    <script>
        ...
        function loadRegisteredEvents() {
            return fetch('../../api/registration/get_registered_events.php')
                .then(response => response.json())
                .then(data => {
        ...
        function submitRegistration(event) {
            ...
            fetch('../../api/registration/register_event.php', {
                method: 'POST',
                body: formData
            })
            .then(response => response.json())
            .then(data => {
                if (data.success) {
                    ...
                    setTimeout(() => {
                        window.location.href = 'view_ticket.php?ticket=' + data.ticket_number + '&new=1';
                    }, 300);
                } else {
