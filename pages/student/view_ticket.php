...
$is_new_registration = isset($_GET['new']) && $_GET['new'] === '1';

if (!$ticket_number) {
    header("Location: ../student/calendar.php");
    exit();
}
...
<head>
    ...
    <style>
        ...
        body::before {
            ...
            width: 100%;
            height: 100%;
            background-image: url("../../assets/images/nu-laguna-hero-1024x461.jpg");
        ...
        <div class="ticket-card">
            ...
            <div class="ticket-body">
                ...
                <div class="action-buttons">
                    ...
                    <button class="btn btn-secondary" onclick="window.location.href='calendar.php<?= $is_new_registration ? '?registered=success' : '' ?>'">
