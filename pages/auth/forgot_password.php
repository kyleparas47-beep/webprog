...
function sendResetCode($email, $code) {
    ...
    // Method 1: Using simple mail() function (works on most servers)
...
<body>
    <div class='container'>
        ...
        <div class='content'>
            <h2>Hello!</h2>
            <p>You have requested to reset your password for your NU Laguna Events account.</p>
    ...
    // Log for debugging
    error_log("Password reset code for $email: $code - Email sent: " . ($emailSent ? 'Yes' : 'No'));
    
    // Return true even if email fails (code is still in database)
