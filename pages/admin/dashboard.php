            ...
            <div class="content-layout">
                <div class="content-left">
                    ...
                    <div class="action-section">
                        <button class="see-events-btn" onclick="window.location.href='../shared/view_events.php'">
                            <span>See Current Events</span>
                            <i class="fas fa-calendar-alt"></i>
                        </button>
                        
                        <a href="calendar.php" class="add-events-link">
                            + add events >
                        </a>
                        ...
                        <div class="carousel">
                            <div class="carousel-track">
                                <div class="carousel-slide">
                                    <img src="../../assets/images/492508047_1000140838968339_1613408679840476886_n.jpg" alt="National University students celebrating and cheering in blue uniforms">
                                </div>
                                <div class="carousel-slide">
                                    <img src="../../assets/images/images.jpg" alt="National University campus event with students gathered outdoors">
                                </div>
                                <div class="carousel-slide">
                                    <img src="../../assets/images/492508047_1000140838968339_1613408679840476886_n.jpg" alt="Students at university event">
                                </div>
                                <div class="carousel-slide">
                                    <img src="../../assets/images/images.jpg" alt="Campus activities">
                                </div>
                                <div class="carousel-slide">
                                    <img src="../../assets/images/492508047_1000140838968339_1613408679840476886_n.jpg" alt="University celebration">
                                </div>
                            </div>
